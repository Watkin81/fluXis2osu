...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert fluXis maps to osu!'s .osz format.")
    parser.add_argument("input_file", help="Path to the input .fsc file from fluXis.")
    parser.add_argument("output_dir", help="Directory where the output .osz file will be created.")
